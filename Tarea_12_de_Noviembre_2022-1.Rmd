...
```{r}
plot.norm.test <- function (data, data2 = NULL, mu0 = NULL, gamma = 0.95, sigma = NULL, sigma2 = NULL, cola = "ambas", main = "", ylab ="Z", xlab ="Probabilidad", col.NR ="blue", col.R = "red", col.t = "black") {
  alfa = 1-gamma
  if(is.null(data2)) {
